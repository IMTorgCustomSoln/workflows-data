...
class Default:
    ...
    def format_message(self, msg):
        record = { 
            'creation_time': msg.message.creation_time,
            'client_submit_time': msg.message.client_submit_time,
            'modification_time': msg.message.modification_time,
            'delivery_time': msg.message.delivery_time,
            'folder': msg.folder.name,
            'from': msg.sender,

            #'to': 'msg.TODO',
            #'subject': msg.subject,
            #'plain_text': msg.plain_text.decode(),
            #'rtf_body': msg.message.rtf_body.decode(),
            #'conversation_topic': msg.message.conversation_topic,
            #'number_of_attachments': msg.number_of_attachments
        }
        pprint.pprint(record)
        return record

# registry of formatters filled when subclasses are created
formatters = {'screen': Default}
